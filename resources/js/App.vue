                ...
                <li class="nav-item dropdown has-arrow main-drop">
                    ...
                    <div class="dropdown-menu menu-drop-user">
                        <div class="profilename">
                            ...
                            <hr class="m-0">
                            <router-link class="dropdown-item" to="/admin/profile"> <i class="me-2" data-feather="user"></i>
        ...
        <div class="sidebar" id="sidebar">
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        <li class="active">
                            <router-link to="/admin/dashboard"><img src="assets/img/icons/dashboard.svg" alt="img"><span>
                                    Dashboard</span> </router-link>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/product.svg" alt="img"><span>
                                    Order Master</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><router-link to="/admin/new_order">New Order</router-link></li>
                                <li><router-link to="/admin/add_category">Add Category</router-link></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/product.svg" alt="img"><span>
                            ...
                            <ul>
                                <li><router-link to="/admin/all_Invoice">New Order</router-link></li>
                                <li><router-link to="/admin/add_category">Add Category</router-link></li>
                            </ul>
                        </li>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><router-link to="/admin/categoryList">All Category</router-link></li>
                                <li><router-link to="/admin/add_category">Add Category</router-link></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            ...
                            <ul>
                                <li><router-link to="/admin/brandList">All Brand</router-link></li>
                                <li><router-link to="/admin/add_brand">Add Brand</router-link></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            <a href="javascript:void(0);"><img src="assets/img/icons/product.svg" alt="img"><span>
                                    IE</span> <span class="menu-arrow"></span></a>
                            <ul>
                                <li><router-link to="/admin/efficiency">Efficiency Report</router-link></li>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><router-link to="/admin/ProductList">Product List</router-link></li>
                                <li><a href="addproduct.html">Add Product</a></li>
                                <li><a href="categorylist.html">Category List</a></li>
                                <li><a href="addcategory.html">Add Category</a></li>
                                <li><a href="subcategorylist.html">Sub Category List</a></li>
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li><router-link to="/admin/User">New User </router-link></li>
                                <li><router-link to="/admin/addUser">New User </router-link></li>
                                <li><router-link to="/admin/user_lists">Users List</router-link></li>
                            </ul>
                        </li>
                        <li class="submenu">
                            ...
                            <ul>
                                <li><router-link to="/admin/factorySetting">General Setting</router-link></li>
                                <li><router-link to="/admin/line">Add Line</router-link></li>
